...
void singleTest(const std::vector<Token>& tokens, const Expression& expected) {
...
BOOST_AUTO_TEST_CASE(TEST_SUM_OF_THREE_INTS) {
    std::vector<Token> tokens = {
        {TokenType::INT_LITERAL, "21"}, {TokenType::OPERATOR, "+"},
        {TokenType::INT_LITERAL, "2"},  {TokenType::OPERATOR, "+"},
...
BOOST_AUTO_TEST_CASE(REGULAR_BRACKET_SEQUENCE_1) {
    std::vector<Token> tokens = {
        ...
        {TokenType::INT_LITERAL, "1"}, {TokenType::OPERATOR, "+"},  {TokenType::INT_LITERAL, "2"},
        {TokenType::DELIMITER, ")"},   {TokenType::OPERATOR, "-"},  {TokenType::DELIMITER, "("},
        {TokenType::INT_LITERAL, "3"}, {TokenType::OPERATOR, "-"},  {TokenType::INT_LITERAL, "4"},
        {TokenType::DELIMITER, ")"},   {TokenType::DELIMITER, ")"}, {TokenType::DELIMITER, ")"},
...
BOOST_AUTO_TEST_CASE(TWO_SEMICOLON_SEPARATED_EXPRESSIONS) {
    std::vector<Token> tokens = {
        {TokenType::IDENTIFIER, "variable1"}, {TokenType::DELIMITER, ";"},
        {TokenType::DELIMITER, ";"},          {TokenType::IDENTIFIER, "variable2"},
        {TokenType::DELIMITER, ";"},          {TokenType::DELIMITER, ";"},
        {TokenType::DELIMITER, ";"},
    };
...
BOOST_AUTO_TEST_CASE(DOUBLE_INPUT) {
    std::vector<Token> tokens = {
        {TokenType::KEYWORD, "input"}, {TokenType::DELIMITER, "("}, {TokenType::KEYWORD, "input"},
        {TokenType::DELIMITER, "("},   {TokenType::DELIMITER, ")"}, {TokenType::DELIMITER, ")"},
    };
...
BOOST_AUTO_TEST_CASE(STARTING_ON_WRONG_KEYWORD) {
    std::vector<Token> tokens = {
        {TokenType::KEYWORD, "val"},   {TokenType::IDENTIFIER, "foo"}, {TokenType::OPERATOR, "="},
        {TokenType::INT_LITERAL, "2"}, {TokenType::DELIMITER, ";"},
    };
    throwTest(tokens);
}
...
BOOST_AUTO_TEST_CASE(STARTING_ON_SEMICOLON) {
    std::vector<Token> tokens = {
        {TokenType::DELIMITER, ";"}, {TokenType::INT_LITERAL, "12"},
        {TokenType::OPERATOR, "+"},  {TokenType::INT_LITERAL, "3"},
        {TokenType::OPERATOR, "+"},  {TokenType::STRING_LITERAL, "\"That's Amore\""},
    };
    throwTest(tokens);
}
