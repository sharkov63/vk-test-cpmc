...
namespace cpmc {
    ...
    class CppCompiler {
        private:
             ...
             *
             * The arguments should be such that if destination file is added right after,
             * the compiler will compile source code from stdin into specified destination file.
             *
        ...
        public:
             ...
             *
             * The method waits until the compilation is finished (or returns with non-zero exit status).
             *
             * @throws CompilationException if something went wrong during compilation process.
             */
            void compile(const CppSourceCode& src, const std::string& destination) const;
    };
}  // namespace cpmc
